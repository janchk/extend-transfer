...
class INet:
    ...
    def process(self):
        ...
        rescale_image = str_to_bool(self.rescale_image)
        maintain_aspect_ratio = str_to_bool(self.maintain_aspect_ratio)
        preserve_color = str_to_bool(self.color)
